...
def MetashapeProcess(root_path, folder_name, start_step=1, end_step=7, 
                    ...
                    #   3=sparse point cloud filtering, part 1
                    #   4=detect markers, and create add scalebars and scale the project
...
#        # set export projection (not working here)
...
#        out_projection.crs = Metashape.CoordinateSystem("EPSG::32604")
        ...
        chunk.exportRaster(os.path.join(arc_path, survey_year+'_'+folder_name+'_dem.tif'), 
                           resolution=0.001, save_world=True, source_data=Metashape.ElevationData)
        
#        # extra export DEM at corser resolution for Hannah
#        chunk.exportRaster(os.path.join(arc_path, survey_year+'_'+folder_name+'_dem_1cm.tif'), 
#                           resolution=0.01, save_world=True, source_data=Metashape.ElevationData)    
